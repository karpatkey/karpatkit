...
class GnosisContractSpecs:
    ...
    GBPe_x3RCV_pool = ContractSpec(
        address="0x0ff26a978a61d40f6591fc700ef878e96af6c2c0", abi_path=current_dir() / "curve_two_crypto_optimized.json",
    ...
    EURe_x3RCV_deposit_zap = ContractSpec(
        address="0xE3FFF29d4DC930EBb787FeCd49Ee5963DADf60b6", abi_path=current_dir() / "zap_two.json",
    ...
    x3Pool = ContractSpec(
        address="0x7f90122BF0700F9E7e1F688fe926940E8839F353", abi_path=current_dir() / "swap_template_base.json",
        name="x3pool"
    )
