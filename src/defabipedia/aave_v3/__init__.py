from defabipedia.types import Chain, ContractSpec, ContractAbi, current_dir
...
class EthereumContractSpecs:
    ...
    aEthWETH = ContractSpec(address='0x4d5F47FA6A74757f35C14fD3a6Ef8E3C9BC514E8',
                            abi_path=current_dir() / 'aEthWETH.json',
                            name='aEthWETH')
